...
pub use hbs_acc_pow_sys::heartbeat_acc_pow_context as HeartbeatAccPowContext;
pub use hbs_acc_pow_sys::heartbeat_acc_pow_record as HeartbeatAccPowRecord;
pub use hbs_acc_pow_sys::heartbeat_acc_pow_window_complete as HeartbeatAccPowWindowComplete;
...
impl HeartbeatAccPow {
    ...
    pub fn new(window_size: usize,
               hwc_callback: Option<HeartbeatAccPowWindowComplete>,
